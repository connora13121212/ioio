...
define('CAMPAIGN_ID', "ffa21f4c72d6641f60f31361af6b829c");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '07a310aaa29698e5566f5227cb62135c');
define('MP_PARAM_NAME', '_ft_clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'c2ed9aaf72b5954012fbd58b7f378d25');
define('CHECK_MCPROXY_VALUE', '67bc6cf422157d7520ec49732eff73db28c763275f5e9131d1eb0361d03469e6');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '10845.3');
...
$url=$url.'&campid='.$_SERVER['HTTP_HOST'];
